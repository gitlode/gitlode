...
| M2        | P1/P2 accepted; P3 correction review pending | Full T13B, readability, system-test organization, final candidate and T13C |
...
P3 correction round 1 returned at `61a34c1f13ee993099c4611b3e4ac966b2ab132c`, with implementation
`255b0aa` and outcome `094dcb8`. Post-implementation changes are handoff-only. Next is
[P3 correction focused re-review](opentelemetry-m2-profile-p3-review.md#p3-correction-round-1-focused-re-review)
for Scope identity, escaping/missing-only retention, diagnostic quantity/order and styling roles.
P3 remains unaccepted; P1/P2 remain accepted. Reported nine-suite/72-test and per-group fail-before
results are implementer evidence until independently checked. Human real-TTY light/dark confirmation
and cumulative Windows/Linux validation remain later assignments; ordinary non-TTY captures do not
substitute for either. No formal/package campaign is assigned to the review.
...
chooses squash/merge strategy and performs the merge or branch deletion. Only the named P3 correction focused re-review

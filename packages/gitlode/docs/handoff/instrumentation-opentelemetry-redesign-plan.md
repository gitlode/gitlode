...
| T13B | pending  | M0 complete: frozen harness and one-target calibration/capture/disabled/profile comparisons accepted; next is M1 placement and release-gate preparation; full reference calibration and formal acceptance remain M2 obligations                                                                                                               |
| T13C | pending  | —                                                                                                                                                                                                                                                                                                                                             |

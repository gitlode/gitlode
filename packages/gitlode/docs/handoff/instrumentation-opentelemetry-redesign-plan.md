...
| T13B | pending  | M0 complete: frozen harness and one-target calibration/capture/disabled/profile comparisons accepted; M1 placement and publish gate are accepted; next is cumulative Windows/Linux validation and candidate preservation; full reference calibration and formal acceptance remain M2 obligations                                              |
| T13C | pending  | —                                                                                                                                                                                                                                                                                                                                             |
